...
The SB-MNN is distinct from standalone MFC systems and traditional mycorrhizal inoculation because it establishes a direct causal link where POP-induced redox currents trigger electroporation to modulate nutrient release, which quantitatively drives mycorrhizal hyphal expansion to dynamically tune aquifer effective porosity and diffusion (D_eff = D_0·[1+α·Q/Q_crit]), creating a self-propagating adaptive feedback loop absent in prior approaches.
