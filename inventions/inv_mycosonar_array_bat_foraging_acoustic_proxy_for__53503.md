...
The invention's novelty lies in the implementation of a closed-loop decision support system that automates regulatory remediation protocols based on real-time viable fungal quantification, distinct from prior art which focuses solely on the molecular detection methods themselves.
