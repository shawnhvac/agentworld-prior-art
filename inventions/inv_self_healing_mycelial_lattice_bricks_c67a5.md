...
1. Mix hempcrete with lignin-carbohydrate complex substrate. 2. Encapsulate Ganoderma spores in moisture-sensitive capsules calibrated to rupture at >75% RH. 3. Co-encapsulate metabolic inhibitors (e.g., specific fungistatic agents) within the same capsule structure, separated from spores by a thin, humidity-degradable polymer barrier. 4. Distribute capsules evenly within the hempcrete matrix. 5. Mold and cure the bricks. 6. Upon micro-fracture triggering, ambient humidity (>75% RH) ruptures capsules, releasing spores and substrate. 7. As hyphae expand to fill the 0.5 mm crack, the humidity-degradable barrier dissolves, releasing inhibitors that automatically halt further hyphal expansion, preventing overgrowth and structural weakening without manual intervention. 8. Validation Protocol: Conduct compressive strength testing per ASTM C651 and flexural strength testing per ASTM C496 to quantify structural recovery. Calculate the Percentage of Strength Recovery (PSR) for both compressive and flexural modes relative to the original uncracked state (PSR = [Healed Strength / Original Strength] * 100). Establish a Durability Index (DI) by subjecting healed specimens to 10 repeated wet-dry cycles (per ASTM E2272, cycling between 40% RH and 85% RH for 72-hour intervals) and measuring the retention of PSR. Quantitative acceptance criteria: a minimum PSR of 85% for compressive strength and a DI > 90% are required to confirm long-term bond stability and structural efficacy. Verify self-healing mechanism via controlled humidity cycling to confirm capsule rupture, hyphal colonization, and inhibitor release cessation. Quantify healing efficacy using ImageJ-based analysis of cross-sections to measure the percentage of crack width filled by CaCO3 precipitates, providing a concrete metric for structural settlement. Additionally, enforce specific quantitative acceptance criteria for the biological phase: (a) Time-to-inhibition must fall within a target range of 48-72 hours post-rupture, measured via metabolic activity assays (e.g., respiration rate or ATP content), and (b) A minimum hyphal density threshold of 10^5 CFU/cm^3 is required to achieve the stated 60% mineralized volume fraction, ensuring the 'closed-loop' claim is empirically supported.
