...
4. **Intermediate Validation Check (Real-time):** Before proceeding to final efficiency metrics, the actual electro-osmotic flow velocity (m/s) and shear stress (Pa) are measured
