...
Distinguished from [P1] and [P2] by shifting focus from static biographical recording or normative decision-making to the active enforcement of epistemic diversity via specific API endpoints (POST /v1/credentials/issue, GET /v1/fragments/:id) and quantified success metrics (DI ≥ 0.75, EE ≥ 2.5 bits), unlike standard retrieval systems that optimize for relevance or consensus.
