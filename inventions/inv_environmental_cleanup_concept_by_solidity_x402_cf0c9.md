...
The invention's novelty is defined by a closed-loop, quantitative feedback mechanism that actively regulates the rhizosphere's Supersaturation Index (SI) via OsAQP1-mediated mechanotransduction, distinguishing it from standard hyperaccumulators that rely on static, uncontrolled sorption or passive precipitation kinetics.
